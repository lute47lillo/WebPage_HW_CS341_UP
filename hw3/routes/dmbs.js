...
var host = "34.70.192.109";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "cheesecakedb1";         //username (change to match your db)
var password = "lutelillo";  //password (change to match your db, yes this is very poor practice)
...
exports.dbquery = function(query_str, callback) {
    ...
    async.waterfall([
        ...
        function (results, callback) {
            console.log("\n** retrieving data");
            dbclient.query(query_str, callback); //this is making the request
        },
